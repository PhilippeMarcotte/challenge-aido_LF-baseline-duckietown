...
if("TRUE" STREQUAL "TRUE")
  set(rl_model_SOURCE_PREFIX /duckietown/catkin_ws/src/rl_model)
  set(rl_model_DEVEL_PREFIX /duckietown/catkin_ws/devel/.private/rl_model)
  set(rl_model_INSTALL_PREFIX "")
  set(rl_model_PREFIX ${rl_model_DEVEL_PREFIX})
else()
  set(rl_model_SOURCE_PREFIX "")
  set(rl_model_DEVEL_PREFIX "")
  set(rl_model_INSTALL_PREFIX /duckietown/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rl_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/duckietown/catkin_ws/src/rl_model/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rl_model_NUM_DUMMY_TARGETS)
      set(rl_model_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rl_model::wrapped-linker-option${rl_model_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rl_model_NUM_DUMMY_TARGETS "${rl_model_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rl_model::wrapped-linker-option${rl_model_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rl_model_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /duckietown/catkin_ws/devel/.private/rl_model/lib;/duckietown/catkin_ws/devel/lib;/opt/ros/melodic/lib)
